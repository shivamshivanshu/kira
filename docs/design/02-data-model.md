...
| `priority` | string | no | Free-form (e.g. `P0`..`P3`); not config-validated in v1. | mutable |
...
`sprint` is a reserved-but-unused key: see non-goals in the synthesis. Do not add it in v1.
